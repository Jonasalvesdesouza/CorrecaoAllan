...
import { ResultShowComponent } from "../../index";
...
export class FormCreateComponent implements OnInit {
  ...
  validateProbabilities(): boolean {
    if (
      this.probabilidadeCruzamento !== null &&
      (this.probabilidadeCruzamento < 0 || this.probabilidadeCruzamento > 100)
    ) {
      this.toastr.warning(
    ...
    if (
      this.probabilidadeMutacao !== null &&
      (this.probabilidadeMutacao < 0 || this.probabilidadeMutacao > 40)
    ) {
      this.toastr.warning(
  ...
  validateCromossomos(): boolean {
    if (
      this.cromossomos !== null &&
      (this.cromossomos < 2 || this.cromossomos % 2 !== 0)
    ) {
      this.toastr.warning(
  ...
  validateIterationCount(): boolean {
    if (
      ...
      if (
        this.quantidadeMaxInteracoes < 1 ||
        this.quantidadeMaxInteracoes <= this.interacoesSemMelhorias
      ) {
        this.toastr.warning(
